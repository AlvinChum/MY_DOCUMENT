<?php if (!defined('THINK_PATH')) exit();?><h3><?php echo ($name); ?>文章栏目</h3>
        ...
        <div class="formitm">
          ...
          <a class="u-btn u-btn-primary u-img-upload" data="image" preview="image-preview" href="javascript:;" id="upload">上传</a> <a class="u-btn u-btn-primary"href="javascript:;" id="image-preview">预览</a>
