...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
    ...
    <body> 
                ...
                <div id="bod">
                   ...
                   <div  id="loading" style="display: none"><div class="loading-div"></div><img src="themes/shanmao_me_new_app/images/jiazai.gif"  class="loading-img"></div>
					...
					<a href="javascript:;" class="btn btn-primary">推荐</a>
                    ...
                    <div class="categories_xiala">
					  ...
					  <?php $listList = service("DuxCms","Label","categoryList",array("app"=>"DuxCms","label"=>"categoryList","limit"=>"20","parent_id"=>"19","item"=>"list",)); if(is_array($listList)): foreach($listList as $list): ?><a href="<?php echo ($list["curl"]); ?>"  class="btn  <?php if($list['class_id']==$topCategoryInfo['class_id']): ?>btn-primary<?php endif; ?>  "><?php echo ($list["name"]); ?></a><?php endforeach; endif; ?>   			
									...
									<?php echo service("DuxCms","Label","fragment",array("app"=>"DuxCms","label"=>"fragment","mark"=>"list_ad1","class_id"=>"999",)); ?>
									 ...
									 <?php $voList = service("DuxCms","Label","contentList",array("app"=>"DuxCms","label"=>"contentList","limit"=>"10","item"=>"vo","order"=>"A.actionstatus,A.index_time desc,A.sequence","top_id"=>"1","set"=>"1",)); if(is_array($voList)): foreach($voList as $vo): ?><div class="media_link" style="position: relative;"> 
					         <i class="zhiding"><img src="themes/shanmao_me_new_app/images/zhiding.png"></i>
    ...
    $(document).ready(function(){  
        ...
        $(window).scroll(function(){ 
			...
			$("#loading").show();
            $.getJSON("<?php echo U('Home/Index/index');?>",{p:num,ajax:1},function(data){
				$("#loading").hide();         	
      ...
      <!-- 置顶漂浮 -->
        <script type="text/javascript" src="<?php echo ($css_path); ?>js/navfix.js"></script>
			<script type="text/javascript">
