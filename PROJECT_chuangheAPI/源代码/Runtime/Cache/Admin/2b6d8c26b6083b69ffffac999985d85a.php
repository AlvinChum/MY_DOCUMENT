<?php if (!defined('THINK_PATH')) exit();?><h3>列表</h3>
  ...
  <div class="m-table-mobile"><table id="table" class="m-table "><thead><tr><th width="30">选择</th><th>编号</th><th>uid</th><th width="100">用户名</th><th>变动金额</th><th>投放id</th><th>ip</th><th>描述</th><th width="130">创建时间</th></tr></thead><tbody><?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
        <td>
