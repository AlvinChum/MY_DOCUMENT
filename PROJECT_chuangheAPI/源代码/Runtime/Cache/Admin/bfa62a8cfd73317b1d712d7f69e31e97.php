...
<div class="main" style="margin-top:-123px;">
	<div class="licenseblock"><div class="license"><h1>景诺网络服务协议</h1>



<p><b>感谢您选择景诺产品。景诺公司网址为 http://www.jnooo.cn/，产品官方讨论区网址为 http://bbs.jnooo.cn。</b></p>
<p>本授权协议适用且仅适用于 山猫分享网赚系统V2.0版本以及后续的升级版本，景诺（厦门）网络科技有限公司拥有对本授权协议的最终解释权。</p>

<p>用户须知：您在使用本服务时须遵守法律法规，不得利用本服务从事违法违规行为，包括但不限于：
<ol>
<li>发布、传送、传播、储存危害国家安全统一、破坏社会稳定、违反公序良俗、侮辱、诽谤、淫秽、暴力以及任何违反国家法律法规的内容；</li>
<li>发布、传送、传播、储存侵害他人知识产权、商业秘密等合法权利的内容；恶意虚构事实、隐瞒真相以误导、欺骗他人；发布、传送、传播广告信息及垃圾信息；其他法律法规禁止的行为。</li>
<li>如果您违反了约定，相关国家机关或机构可能会对您提起诉讼、罚款或采取其他制裁措施，并要求景诺给予协助。造成损害的，您应依法予以赔偿，景诺不承担任何责任。您在使用本服务过程中应当遵守当地相关的法律法规，并尊重当地的道德和风俗习惯。如果您的行为违反了当地法律法规或道德风俗、宗教信仰等，您应当为此独立承担责任。</li>
<li>您应避免因使用本服务而使景诺卷入政治和公共事件，否则景诺有权暂停或终止对您的服务并保留向您追偿的权利。您同意，未经景诺许可，不使用任何可能对景诺产品或服务造成任何不良影响的第三方软件，如果擅自使用第三方软件给景诺造成损失的，景诺保留对您追偿的权利。</li>
<li>您违反本条约定，导致任何第三方损害的，您应当独立承担责任；景诺因此遭受损失的，您也应当一并赔偿。在任何情况下，您不应轻信借款、索要密码或其他涉及财产的网络信息。涉及财产操作的，请一定先核实对方身份，并请经常留意景诺有关防范诈骗犯罪的提示。您有责任自行备份存储在本服务中的数据。如果您的服务被终止，景诺将不对您的任何行为负责。</li></ol>
</p><p></p>
<h3>I. 协议规定的约束和限制</h3>
<ol>
<li>未获景诺公司书面商业授权之前，必须购买授权才可使用。购买商业授权请登陆http://www.jnooo.cn/参考相关说明，也可以致信企业电子邮箱info@jnooo.cn。</li>
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
<li>禁止在景诺产品的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
<li>景诺公司不对使用本软件构建的网站中或者论坛中的文章或信息承担责任，全部责任由您自行承担。</li>
<li>景诺公司无法全面监控由第三方上传至应用中心的应用程序，因此不保证应用程序的合法性、安全性、完整性、真实性或品质等；您从应用中心下载应用程序时，同意自行判断并承担所有风险，而不依赖于景诺公司。但在任何情况下，景诺公司有权依法停止应用中心服务并采取相应行动，包括但不限于对于相关应用程序进行卸载，暂停服务的全部或部分，保存有关记录，并向有关机关报告。由此对您及第三人可能造成的损失，景诺公司不承担任何直接、间接或者连带的责任。</li>
<li>景诺公司对景诺提供的软件和服务之及时性、安全性、准确性不作担保，由于不可抗力因素、景诺公司无法控制的因素（包括黑客攻击、停断电等）等造成软件使用和服务中止或终止，而给您造成损失的，您同意放弃追究景诺公司责任的全部权利。</li>
<li>景诺公司特别提请您注意，景诺公司为了保障公司业务发展和调整的自主权，景诺公司拥有随时经或未经事先通知而修改服务内容、中止或终止部分或全部软件使用和服务的权利，修改会公布于景诺公司网站相关页面上，一经公布视为通知。 景诺公司行使修改或中止、终止部分或全部软件使用和服务的权利而造成损失的，景诺公司不需对您或任何第三方负责。</li>
</ol>

<p>有关景诺产品最终用户授权协议、商业授权与技术服务的详细内容，均由景诺公司独家提供。景诺公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权利，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>一旦您开始安装景诺产品，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权利的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>

<p>本许可协议条款的解释，效力及纠纷的解决，适用于中华人民共和国大陆法律。</p>

<p>若您和景诺之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，您在此完全同意将纠纷或争议提交景诺所在地厦门市集美区人民法院管辖。景诺公司拥有对以上各项条款内容的解释权及修改权。</p>
...
<p align="right"></p>
	...
	<div class="btnbox marginbot">
		...
		<form method="post" autocomplete="off" action="<?php echo U('index');?>">	
		<input type="submit" name="submit" value="我同意" style="padding: 2px">&nbsp;
		<input type="button" name="exit" value="我不同意" style="padding: 2px" onclick="javascript:window.location.href='<?php echo U("Admin/Login/logout");?>'">
		</form>
		
	</div>		<div class="footer"><p>版权所有 闽ICP备15010598号，厦门景诺网络科技有限公司保留所有权利。</p></div>
	</div>
</div>
