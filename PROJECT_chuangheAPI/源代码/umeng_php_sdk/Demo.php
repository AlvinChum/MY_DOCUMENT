...
class Demo {
	...
	function sendAndroidUnicast() {
		try {
			...
			$unicast->setPredefinedKeyValue("device_tokens",    "Ajjj1ooivNZU7bgl7LHa6_q_g9BQ_xA4wEAaFtMEtNYe"); 
	...
	function sendAndroidGroupcast($tagname) {
		try {
			/* 
			...
			$groupcast->setPredefinedKeyValue("title",            "组播标题");
			$groupcast->setPredefinedKeyValue("text",             "组播内容。");
			$groupcast->setPredefinedKeyValue("after_open",       "go_app");			
			// Set 'production_mode' to 'false' if it's a test device. 
			// For how to register a test device, please see the developer doc.
			$groupcast->setPredefinedKeyValue("production_mode", "true");
			$groupcast->setExtraField("url",      "http://bbs.jnooo.cn");
...
$demo = new Demo("567e282c67e58e2495000474", "dpuvigi05kwmr6vvwfgl5gqaktwnku2d");
$demo->sendAndroidUnicast();

// $demo->sendAndroidGroupcast('12345');
