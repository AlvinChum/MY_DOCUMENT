...
var img = '<img src="themes/shanmao_me_new_app/images/app/jinshi_new.png"width="15" alt="">';
...
$(function(){
   ...
   $('.m_pwd').blur(function(){
	...
	$("#denglu").click(function(){
		...
		if(!submit){
			s.innerHTML='登录';s.style.background='#3FA9F5';
			return false;
		}
