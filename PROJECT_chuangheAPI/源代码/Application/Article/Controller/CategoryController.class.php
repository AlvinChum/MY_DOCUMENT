...
class CategoryController extends SiteController {
    ...
    public function index(){
       ...
       // A("Home/Public")->dowxlogin();
        ...
        $pageList = $modelContent->loadList($where,$limit,'A.actionstatus,A.sequence ,'.$categoryInfo['content_order'].'A.time desc,A.content_id desc',$this->uinfo['id']);
        //dump($limit);
        //扩展字段处理   2015-05-06 by Ruizhong Liu copy for shanmao.me
        ...
        $this->assign('categoryInfo', $categoryInfo);
             ...
             $cid = $this->last_position_time($positionId,2);       
    if($positionId&&$cid){		
