...
(function(){
    $.fn.extend({
        "duiduipeng": function (obj) {
            ...
            //对想，性别1，性别2，图像放置1，图像放置2，抽奖结果放置容器，重新全部重置，抽奖按钮，文本数据1，文本数据2，文本抽奖1，文本抽奖2，抽取对数，剩余总数
            var obj=obj;
            var sex1=obj.sex1;
            var sex2=obj.sex2;
            var pice1=obj.pice1;
            ...
            (function loading(data,i,callback,$this,obj){
                ...
                text1.text(sex1.length).addClass('icon');
                text2.text(sex2.length).addClass('icon');
                $this.click(function(){
                    var $this=$(this);
            ...
            function delete_all(obj){
               ...
               this.removeClass('single');
                ...
                pice1.attr('src','');
                pice2.attr('src','');
                text1.text(sex1.length);
                text2.text(sex2.length);
                obj.rank=0;
            ...
            function delete_group(obj){
                ...
                var leng= place.find('li').length;
                var index=$this.parent().find('span').eq(0).text();
            ...
            //抽奖开始.start表示开始抽取的标志，single是删除单个，然后单个抽取
               ...
               var sex2 =obj.sex2;
                ...
                var ranking=obj.ranking;
                    if ($this.hasClass('start')) {
                        ...
                        text1.removeClass('icon');
                        text2.removeClass('icon');
                        for (var i = 0; i < len; i++) {
                            //数据，定时，
