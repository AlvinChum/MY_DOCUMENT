		...
		callback: function( index ) {
			...
			if($(element).data("danmu_array")[$(element).data("nowtime")]){
				...
				for(var i=0;i<danmus.length;i++){
					var a_danmu="<div class='flying flying2' id='linshi'><span style=background-image:url("+danmus[i].img+") ></span><span class='text'></span></div>";
					$(element).append(a_danmu);
					$("#linshi .text").text(danmus[i].text);
					$("#linshi").css({
