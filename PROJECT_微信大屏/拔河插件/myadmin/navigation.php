    ...
    <div class="modal-shiftfix">
      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        <div class="container-fluid top-bar">
          <div class="pull-right">
            <ul class="nav navbar-nav pull-right">
              <li class="dropdown messages hidden-xs"></li>
              ...
              <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img width="34" height="34" src="../img/0.png" />系统管理<b class="caret"></b></a>
                <ul class="dropdown-menu">
          ...
          <button class="navbar-toggle"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="logo" href="index.php">微信墙</a>
        </div>
        ...
        <li>
                    ...
                    <li><a href="user.php">
                            <span aria-hidden="true" class="se7en-feed"></span>用户管理</a>
                    </li>
                    <?php
                    if ($cj) {
                ...
                <span aria-hidden="true" class="se7en-flag"></span>摇一摇管理</a>
                    ...
                    if ($tug) {
                        ...
                        echo '<li><a href="tug.php">
                <span aria-hidden="true" class="se7en-flag"></span>拔河管理</a>
              </li>';
                    }
                    ?>
...
$(function(){
	...
	if(!$('#gongnengs li').html()){
	    $('#gongnengs').append('<li><a href="#">暂无插件</a></li>');
	}
});
</script>
